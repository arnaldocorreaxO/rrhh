...
function message_success(message) {
    ...
    if (type) {
        ...
        alert_sweetalert('success', 'OK!', "OK", function () {
...
function submit_with_ajax_loading(title, content, url, parameters, callback) {
    $.confirm({
        // type: 'blue',
        theme: 'material',
        title: title,
            ...
            info: {
                ...
                action: function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        beforeSend: function () {
                            $('#modal_proceso').modal({ backdrop: 'static', keyboard: false })
